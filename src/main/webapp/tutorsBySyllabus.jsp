						...
						<% 
							...
							<% if (totalItemsLong > 0) { %>
							    ...
							    <div class="paginat">
							        ...
							        %>     
							            <a href="/tutor-syllabus-<%= byLocation %>-<%= currentPage - 1 %>" class="prev"><i class="fas fa-arrow-left"></i></a>
							        <%
							            } else {
							        %>
							        ...
							        %>
							                    <a href="/tutor-syllabus-<%= byLocation %>-<%= i %>" class="page-number"><%= i %></a>
							        <%
							                }
							            }
							        %>
							        ...
							        %>     
							            <a href="/tutor-syllabus-<%= byLocation %>-<%= currentPage + 1 %>" class="next"><i class="fas fa-arrow-right"></i></a>
							        <%
							            } else {
							        %>
